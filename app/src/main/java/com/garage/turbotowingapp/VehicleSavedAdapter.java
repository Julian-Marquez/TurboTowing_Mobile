...
public class VehicleSavedAdapter extends RecyclerView.Adapter<VehicleSavedAdapter.ViewHolder> {
    private List<Vehicle> vehicles;
    private Context context;
    private final String TAG = "VehicleSavedAdapter";

    // Constructor
    public VehicleSavedAdapter(List<Vehicle> vehicles, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(!email.isEmpty()) {
            ...
            for (User user1 : connect.getAllUsers()) {
                ...
                if(email.equals("turbotowing505@gmail.com")) { //admin
                    isAdmin = true;
                }
            }
        ...
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d(TAG,"Passing info: "+ finalUser1.getUserId() + " vehicle ID: "+ vehicleUuid);
                connect.removeUserVehicle(finalUser1.getUserId(),vehicleUuid);
